...
<head>
  ...
  <title>Admin Web IPMY Yogyakarta | Dashboard</title>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <!-- Data Anggota -->
          <li class="nav-item">
            <a href="/home/anggota" class="nav-link">
      ...
      <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="/home/anggota" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="/home/kegiatan" class="small-box-footer">Lebih Rinci <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
        </div>
         <!-- Row Keanggotaan -->
