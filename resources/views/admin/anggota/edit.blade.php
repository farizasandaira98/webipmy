    ...
    <div class="container">
        <div class="card mt-5">
            <div class="card-header text-center">
                Data Anggota IPMY - <strong>EDIT DATA</strong>
            </div>
            <div class="card-body">
                ...
                <form method="post" action="/home/anggota/update/{{$anggota->id}}" enctype="multipart/form-data">

                    {{ csrf_field() }}
                    <div class="form-group">
                        <label>Nomor Anggota</label>
                        <input type="text" name="id_anggota" class="form-control" placeholder="Nomor Anggota .." value="{{ $anggota->id_anggota }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat_tinggal" class="form-control" placeholder="Alamat Tinggal .." value="{{ $anggota->alamat_tinggal }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="alamat_domisili" class="form-control" placeholder="Alamat Domisili .." value="{{ $anggota->alamat_domisili }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nomor_telepon" class="form-control" placeholder="Nomor Telepon .." value="{{ $anggota->nomor_telepon }}">
                    ...
                    <div class="form-group">
                        <label>Motto</label>
                        <input type="text" name="motto" class="form-control" placeholder="Motto .." value="{{ $anggota->motto }}">
